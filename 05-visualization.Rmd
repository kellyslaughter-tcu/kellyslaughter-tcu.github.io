...
Finally, we call the `gather` function from `dplyr` (note that the code assumes we have already loaded `dplyr` into memory) to transition from wide to long.
...
Note that I have turned warning off for this chunk. This option suppresses warnings from appearing on the rendered page / book. 
